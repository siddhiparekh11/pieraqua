<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPhotoBank.aspx.cs" Inherits="cms_ViewPhotoBank" StylesheetTheme="SkinFile" Theme="SkinFile" %>
...
<head id="Head1" runat="server">
    <title>View Photo Bank - Pier Aqua Admin Panel</title>
    ...
    <div id="main">
      ...
      <div id="site_content">
            ...
            <div id="content">
                ...
                <ContentTemplate>
                    <asp:GridView ID="ViewPhotoBankGrid" runat="server" 
                    DataKeyNames="PhotoBankID" AllowPaging="True" OnRowDataBound="ViewPhotoBankGrid_RowDataBound"
                                                Width="100%" AutoGenerateColumns="False"  
                                                OnRowCommand="ViewPhotoBankGrid_RowCommand" OnPageIndexChanging="ViewPhotoBankGrid_PageIndexChanging"
                                                ...
                                                <Columns>
                                                <asp:TemplateField ><ItemTemplate><asp:HiddenField ID="hdnPhotoBankId" Value='<%#Eval("PhotoBankID")%>' runat="server" /></ItemTemplate>

<HeaderStyle ></HeaderStyle>

<ItemStyle ></ItemStyle>
                                                    </asp:TemplateField>
                                                <asp:ButtonField ButtonType="Image" CommandName="ViewPhoto" HeaderText="ViewPhoto" ImageUrl="images/edit1.png"
                                                         Text="Click to View the details" >
                                                       <ItemStyle VerticalAlign="Middle"/>
                                                    </asp:ButtonField>
                                                    
                                                    
                                                    <asp:BoundField  DataField="PhotoPath" HeaderText="PhotoPath" NullDisplayText="-">
                                                        <ItemStyle VerticalAlign="Middle"/>
                                                    </asp:BoundField>
                                                   
                                                    <asp:BoundField DataField="GroupName" HeaderText="Group Name" NullDisplayText="-">
                                                        <ItemStyle VerticalAlign="Middle"/>
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkisactive" AutoPostBack="true" runat="server" />
                                                        </ItemTemplate>
