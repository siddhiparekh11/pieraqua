<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuyerToSupplier.aspx.cs" Inherits="cms_BuyerToSupplier" StylesheetTheme="SkinFile" Theme="SkinFile" %>
               ...
               <tr>
                    ...
                    <asp:GridView ID="ViewBuyerToSupplierGrid" runat="server" DataKeyNames="SerialID" AllowPaging="True"
                                                ...
                                                <Columns>
                                                     ...
                                                     <asp:BoundField DataField="SellerName" HeaderText="Seller Name" NullDisplayText="-">
                                                        <ItemStyle VerticalAlign="Middle"/>
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ProductName" HeaderText="ProductName" NullDisplayText="-">
                                                        <ItemStyle VerticalAlign="Middle"/>
                                                    </asp:BoundField>
